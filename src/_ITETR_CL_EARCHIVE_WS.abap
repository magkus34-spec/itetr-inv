class /ITETR/CL_EARCHIVE_WS definition
  public
  abstract
  create public .
...
public section.
  ...
  class-methods FACTORY
    ...
    returning
      value(RO_INSTANCE) type ref to /ITETR/CL_EARCHIVE_WS
    raising
  ...
  abstract
    importing
      ...
      !IV_CONTENT_TYPE type /ITETR/COM_E_CONTY optional
    returning
      value(RV_INVOICE_DATA) type /ITETR/COM_E_CONTN
    raising
      /ITETR/CX_REGULATIVE_EXCEPTION .
...
CLASS /ITETR/CL_EARCHIVE_WS IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    SELECT SINGLE refcl
      ...
      WHERE bukrs = iv_company
        AND prncl = '/ITETR/CL_EARCHIVE'. "AS 01.01.2022
    IF lv_reference_class IS INITIAL.
      CONCATENATE '/ITETR/CL_EARCHIVE_WS_' ls_company_parameters-intid INTO lv_reference_class.
    ENDIF.
  ...
  METHOD run_service.
    DATA: lv_request_length  TYPE i,
          ...
          ls_request_header  TYPE /itetr/cl_earchive_ws=>mty_service_header,
